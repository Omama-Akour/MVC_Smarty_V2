...
<head>
  ...
  <title>{block name=title}SB Admin 2 - Dashboard{/block}</title>
...
<body id="page-top">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">{block name=title}{/block}</h1>
          </div>
  ...
  <!-- Page level plugins -->
  <script src="../../../mvcdashboard/public/admin_assests/vendor/chart.js/Chart.min.js"></script>
</body>
</html>
